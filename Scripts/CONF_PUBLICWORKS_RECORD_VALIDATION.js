{
    ...
    "WorkflowTaskUpdateBefore": [
      {
        ...
        "action": {
          "validationMessage": "All invoiced fees must paid before a permit can be issued."
        },
        "postScript": ""
      }
    ],
    "InspectionScheduleBefore": [
      {
        ...
        "action": {
          "validationMessage": "All invoiced fees must paid before an inspection can be scheduled."
        }
      }
    ]
  },
  ...
  "PublicWorks/Special Event/NA/NA": {
    "WorkflowTaskUpdateBefore": [
      ...
      },
      {
        ...
        "action": {
          "validationMessage": "All invoiced fees must paid before plans are routed for review."
        },
        "postScript": ""
      }
    ],
    ...
    "WorkflowTaskUpdateBefore": [
      {
        ...
        "action": {
          "validationMessage": "All invoiced fees must paid before a permit can be renewed."
        },
        "postScript": ""
      }
    ]
  ...
  "PublicWorks/ADA Curb Ramp/NA/NA": {
    "WorkflowTaskUpdateBefore": [
      {
        "metadata": {
          "description": "All invoiced fees must be paid before a request can be approved.",
          "operator": ""
        },
        "preScript": "",
        "criteria": {
        ...
        "action": {
          "validationMessage": "All invoiced fees must be paid before a request can be approved."
        },
        "postScript": ""
      }
    ]
